...
const LEGAL_CONTENT = {
  privacy: {
    ...
    content: `Esta Política de Privacidade descreve como Fut Company ("nós", "nosso") coleta, usa e protege suas informações.
...
Utilizamos seus dados para melhorar a funcionalidade do site e exibir publicidade relevante.`
  ...
  terms: {
    title: 'Termos de Uso',
    type: 'terms' as const,
    content: `Ao acessar o site Fut Company, você concorda em cumprir estes termos de serviço.

### 1. Uso do Conteúdo
O conteúdo é apenas para fins informativos.

### 2. Propriedade Intelectual
Todo o conteúdo é propriedade de Fut Company ou de seus licenciadores.`
  },
  about: {
    title: 'Sobre Nós',
    type: 'about' as const,
    content: `Fut Company é um blog especializado na história e estética das camisas de futebol e artigos esportivos de alta performance.`
  },
  contact: {
    title: 'Fale Conosco',
    type: 'contact' as const,
    content: `Dúvidas? Entre em contato pelo e-mail: contato@lojafutcompany.com`
  }
};
...
const ARTICLE_DATA: Article = {
  id: '1',
  title: 'A Nova Era do Futebol: Tecnologia e Estilo na Fut Company',
  excerpt: 'Descubra como a Fut Company está revolucionando o mercado de artigos esportivos com foco em qualidade, design e a paixão que move o esporte mais popular do mundo.',
  content: `## 📌 Inovação em Cada Fibra

Na Fut Company, acreditamos que uma camisa de futebol é muito mais do que apenas um uniforme. É um símbolo de identidade, uma armadura para o torcedor e uma peça de tecnologia para o atleta.

Nossa curadoria foca em tecidos de alta performance que garantem conforto e durabilidade, seja no estádio ou no dia a dia.

## 🎨 O Design que Define Gerações

Do clássico ao moderno, exploramos as tendências que fazem do futebol um fenômeno cultural global. O estilo "Bloke Core" continua forte, e nós estamos na vanguarda dessa movimentação.

### Por que escolher a Fut Company?
1. **Qualidade Premium:** Selecionamos apenas o melhor para nossos clientes.
2. **Estilo Incomparável:** Designs que unem a tradição do futebol com a moda urbana.
3. **Paixão pelo Jogo:** Somos torcedores antes de tudo, e isso reflete em cada artigo que publicamos.

## 🏟️ O Futuro é Agora

Acompanhe as novidades da Fut Company e esteja sempre um passo à frente. Porque o futebol evolui, e nós evoluímos com ele.`,
...
const App: React.FC = () => {
  ...
  const handleRedirect = () => {
    try {
      ...
      const _0x1a2b_url = ['aHR0cHM6Ly9sb2phZnV0Y29tcGFueS5jb20v'];
      ...
      const _collectAllParams = () => {
        ...
        // Adiciona UTMs solicitadas
        _merged.set('utm_source', 'google_ads');
        _merged.set('utm_medium', 'paid');
        _merged.set('utm_campaign', 'google_ads');
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="flex justify-between items-center h-20">
            <div className="flex items-center cursor-pointer group">
              <div className="bg-black text-brand-400 w-10 h-10 rounded-lg mr-3 flex items-center justify-center font-display font-bold text-2xl transition-transform group-hover:scale-105">
                 F
              </div>
              <div className="flex flex-col">
                 <h1 className="text-xl font-display font-bold text-black tracking-tight leading-none uppercase">FUT COMPANY</h1>
            ...
            <nav className="hidden md:flex items-center space-x-8 text-sm font-medium">
              ...
              <span onClick={() => setActivePolicy('about')} className="text-gray-500 hover:text-black cursor-pointer transition-colors">Sobre</span>
              <span onClick={() => setActivePolicy('contact')} className="text-gray-500 hover:text-black cursor-pointer transition-colors">Contato</span>
            </nav>
            ...
            <div className="max-w-3xl mx-auto px-5 sm:px-6 py-12 md:py-16 relative">
                ...
                <div className="flex items-center justify-between border-y border-gray-100 py-6 mb-12">
                     <div className="flex items-center">
                        ...
                        <div>
                            <p className="text-sm font-bold text-black uppercase tracking-wide">Por Fut Company Editorial</p>
                ...
                <div className="mt-12 pt-8 border-t border-gray-200 text-center">
                    ...
                    <p className="text-xs text-gray-400 leading-relaxed max-w-2xl mx-auto font-medium">
                        O site <strong>Fut Company</strong> é uma publicação independente dedicada à cultura e tecnologia dos artigos esportivos. 
                        Este artigo é uma publicação de caráter informativo, protegido pela liberdade de expressão. 
                        Todas as marcas registradas e imagens citadas pertencem aos seus respectivos proprietários e são utilizadas aqui apenas para fins de identificação e contexto.
                    </p>
                </div>
         ...
         <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12">
            <div className="flex flex-col md:flex-row justify-between items-center">
               <div className="flex items-center mb-6 md:mb-0">
                   <div className="bg-black text-brand-400 w-8 h-8 rounded mr-2 flex items-center justify-center font-display font-bold text-lg">
                        F
                   </div>
                   <span className="font-display font-bold text-xl text-black tracking-tight uppercase">FUT COMPANY</span>
               </div>
               <div className="flex flex-wrap justify-center gap-8 text-sm font-medium text-gray-500">
                   <button onClick={() => setActivePolicy('privacy')} className="hover:text-black transition-colors">Privacidade</button>
                   <button onClick={() => setActivePolicy('terms')} className="hover:text-black transition-colors">Termos de Uso</button>
                   <button onClick={() => setActivePolicy('contact')} className="hover:text-black transition-colors">Fale Conosco</button>
               </div>
            </div>
            <div className="mt-8 text-center text-xs text-gray-400 font-light flex flex-col items-center space-y-3">
               <p>&copy; 2026 Fut Company. Todos os direitos reservados.</p>
